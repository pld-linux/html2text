...
Summary(pl):	Narzêdzie z lini poleceñ do konwersji dokumentów HTML do czystego tekstu
Name:		html2text
Version:	1.3.2a
Release:	1
...
%description
html2text jest programem z linii poleceñ do konwersji dokumentów HTML
do czystego tekstu.
